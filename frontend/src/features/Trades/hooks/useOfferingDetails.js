// useOfferingDetails.js
import { useEffect, useState } from 'react';
import { parsePokemonKey } from '../../../utils/PokemonIDUtils';

export function useOfferingDetails(trade, variants, ownershipData) {
  ...
  useEffect(() => {
    ...
    const offeringOwnership = ownershipData[trade.pokemon_instance_id_user_proposed];
