...
const Discover = () => {
        ...
        if (data && typeof data === 'object' && Object.keys(data).length > 0) {
          ...
          const formattedData = Object.values(data).map((item) => {
            ...
            return {
              ...
              location: item.location_caught || 'Vancouver', // Use 'Vancouver' as a fallback or appropriate field
  ...
  return (
    <div>
      <PokemonSearchBar onSearch={handleSearch} isLoading={isLoading} setErrorMessage={setErrorMessage} />
