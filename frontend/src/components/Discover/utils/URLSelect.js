    ...
    if (isShiny && isShadow) {
      if (pokemonInfo.shadow_shiny_available) {
        url = isFemale && hasFemaleData && hasUniqueFemaleForm
          ? pokemonInfo.female_data.image_url_shiny_shadow || pokemonInfo.female_data.image_url_shiny || pokemonInfo.female_data.image_url
          : pokemonInfo.image_url_shiny_shadow || pokemonInfo.image_url_shiny;
      } else {
        url = isFemale && hasFemaleData && hasUniqueFemaleForm
          ? pokemonInfo.female_data.image_url_shadow || pokemonInfo.female_data.image_url
          : pokemonInfo.image_url_shadow;
      }
    } else if (isShiny) {
      url = isFemale && hasFemaleData && hasUniqueFemaleForm
        ? pokemonInfo.female_data.image_url_shiny || pokemonInfo.female_data.image_url
      ...
      url = isFemale && hasFemaleData && hasUniqueFemaleForm ? pokemonInfo.female_data.image_url : pokemonInfo.image_url;
    }
