...
const styles = StyleSheet.create({
  ...
  content: { paddingHorizontal: 13, paddingTop: 12, paddingBottom: 104 },
  textLight: { color: '#102a32' },
  bodyLight: { color: '#385a63' },
  hero: { gap: 14, padding: 15, borderWidth: 1, borderColor: 'rgba(102,220,220,0.28)', borderRadius: 16, backgroundColor: '#121a1e' },
  ...
  heroMain: { flexDirection: 'row', alignItems: 'flex-start', gap: 10 },
  iconShell: { width: 48, height: 48, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#34474f', borderRadius: 24, backgroundColor: '#1b2529' },
  ...
  body: { color: '#b6c9cd', fontSize: 13, lineHeight: 21 },
