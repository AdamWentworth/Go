...
const styles = StyleSheet.create({
  ...
  productHeader: { minHeight: 64, flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 2 }, back: { width: 42, height: 42, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(142,197,201,0.34)', borderRadius: 21, backgroundColor: '#141a1b' }, backText: { marginTop: -4, color: '#f4ffff', fontSize: 37, lineHeight: 39 }, productIcon: { width: 42, height: 42 }, headerCopy: { minWidth: 0, flex: 1 }, eyebrow: { color: '#8ec5c9', fontSize: 9, fontWeight: '900', letterSpacing: 1.2 }, title: { color: '#f4ffff', fontSize: 22, fontWeight: '900', lineHeight: 25 }, population: { flexDirection: 'row', alignItems: 'center', gap: 5, minWidth: 66, paddingHorizontal: 7, paddingVertical: 6, borderWidth: 1, borderColor: 'rgba(66,215,196,0.3)', borderRadius: 7, backgroundColor: 'rgba(66,215,196,0.07)' }, populationLight: { borderColor: 'rgba(21,117,119,0.3)', backgroundColor: 'rgba(27,185,173,0.08)' }, populationIcon: { color: '#42d7c4', fontSize: 16 }, populationValue: { color: '#f4ffff', fontSize: 14, fontWeight: '900', lineHeight: 15 }, populationLabel: { color: '#9eb9bb', fontSize: 7, fontWeight: '900' },
  segment: { flexDirection: 'row', gap: 4, marginTop: 8, padding: 4, borderWidth: 1, borderColor: 'rgba(66,215,196,0.3)', borderRadius: 8, backgroundColor: '#101617' }, segmentButton: { minHeight: 46, flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, borderRadius: 5 }, segmentActive: { backgroundColor: '#42d7c4' }, segmentIcon: { color: '#9eb9bb', fontSize: 14 }, segmentText: { color: '#9eb9bb', fontSize: 13, fontWeight: '900' }, segmentTextActive: { color: '#071312' },
  ...
  card: { minHeight: 116, flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', gap: 6, padding: 8, borderWidth: 1, borderBottomWidth: 0, borderColor: 'rgba(66,215,196,0.3)', backgroundColor: '#141a1b' }, cardLight: { borderColor: 'rgba(21,117,119,0.3)', backgroundColor: '#fffdf7' }, cardAlternate: { backgroundColor: '#171e1f' }, cardAlternateLight: { backgroundColor: '#f8f8f2' }, pressed: { opacity: 0.72 }, rank: { width: 35, height: 35, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(66,215,196,0.3)', borderRadius: 18 }, rankText: { color: '#42d7c4', fontSize: 13, fontWeight: '900' }, rankTextMedal: { color: '#17130a' }, pokemonSummary: { minWidth: 0, flex: 1, flexDirection: 'row', alignItems: 'center', gap: 6 }, artworkStage: { position: 'relative', width: 67, height: 67, alignItems: 'center', justifyContent: 'center' }, artwork: { width: 72, height: 72 }, maxIcon: { position: 'absolute', right: -1, top: 0, width: 19, height: 19 }, cardIdentity: { minWidth: 0, flex: 1 }, name: { color: '#f4ffff', fontSize: 15, fontWeight: '900', lineHeight: 18 }, personalRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 3, marginTop: 4 }, personal: { paddingHorizontal: 5, paddingVertical: 3, borderWidth: 1, borderColor: 'rgba(66,215,196,0.35)', borderRadius: 4, color: '#9eb9bb', backgroundColor: 'rgba(66,215,196,0.07)', fontSize: 8, fontWeight: '900', textTransform: 'uppercase' }, personalLight: { color: '#405b56' }, countBlock: { width: '100%', marginLeft: 41, gap: 4 }, count: { color: '#f4ffff', fontSize: 11, fontWeight: '900' }, track: { height: 5, overflow: 'hidden', borderRadius: 3, backgroundColor: 'rgba(159,191,193,0.14)' }, trackLight: { backgroundColor: 'rgba(21,117,119,0.13)' }, fill: { height: '100%', borderRadius: 3, backgroundColor: '#42d7c4' }, openLabel: { alignSelf: 'flex-start', color: '#42d7c4', fontSize: 9, fontWeight: '900' },
