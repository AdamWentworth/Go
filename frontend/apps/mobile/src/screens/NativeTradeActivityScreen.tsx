...
const styles = StyleSheet.create({
  screen: { flex: 1, gap: 10, paddingTop: 8, backgroundColor: '#07100f' },
  ...
  pageTitle: { color: '#f4faf8', fontSize: 28, fontWeight: '900', textAlign: 'center' },
  pageDescription: { maxWidth: 420, color: '#9db6b2', fontSize: 15, lineHeight: 20, textAlign: 'center' },
  ...
  statusTab: { flex: 1, minHeight: 54, alignItems: 'center', justifyContent: 'center', gap: 3, borderRadius: 8, paddingHorizontal: 2 },
  ...
  emptyListContent: { flexGrow: 1, paddingHorizontal: 8, paddingBottom: 28 },
  ...
  emptyState: { flex: 1, minHeight: 280, alignItems: 'center', justifyContent: 'center', gap: 8, borderWidth: 1, borderStyle: 'dashed', borderColor: '#2b5a53', borderRadius: 13, padding: 26, backgroundColor: '#111b1a' },
  ...
  stateTitle: { color: '#ffffff', fontSize: 19, fontWeight: '900', textAlign: 'center' },
  stateBody: { maxWidth: 340, color: '#9fb7b2', fontSize: 14, lineHeight: 20, textAlign: 'center' },
