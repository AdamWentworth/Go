...
const references = [
  ...
  ['collection-instance-overlay', 'collection-instance-overlay', 'desktop-collection-instance-smoke-shadow-venusaur'],
  ['collection-trade-overlay-mobile', 'collection-trade-overlay-mobile', 'collection-instance-smoke-gmax-charizard-initial'],
  ['collection-wanted-overlay-mobile', 'collection-wanted-overlay-mobile', 'collection-instance-smoke-gmax-blastoise-initial'],
