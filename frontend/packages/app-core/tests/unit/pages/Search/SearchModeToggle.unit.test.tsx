...
describe('SearchModeToggle', () => {
  it('renders welcome style modifiers when isWelcome is true', () => {
    ...
    expect(screen.getByRole('button', { name: 'Trainers' })).toHaveClass('large');
    expect(screen.getByRole('button', { name: 'Pokémon' })).toHaveClass('large');
  });
  ...
  it('marks only the active mode button', () => {
    ...
    expect(screen.getByRole('button', { name: 'Trainers' })).toHaveClass('active');
    expect(screen.getByRole('button', { name: 'Pokémon' })).not.toHaveClass(
      'active',
    );
    ...
    expect(screen.getByRole('button', { name: 'Pokémon' })).toHaveClass('active');
    expect(screen.getByRole('button', { name: 'Trainers' })).not.toHaveClass(
      'active',
    );
  });
