...
7. Save snapshots under:
   - `frontend/apps/web/.artifacts/tests/reports/perf/local/<label>.json` (recommended naming below)
...
- `frontend/apps/web/.artifacts/tests/reports/perf/bundle-budget.json`
