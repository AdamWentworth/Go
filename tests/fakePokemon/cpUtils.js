...
/**
 * The same multipliers you have on the frontend
 */
const cpMultipliers = {
    1: 0.094,
    1.5: 0.135137432,
  ...
  function calculateCP(
    ...
    // Pokémon GO typically enforces a minimum CP of 10, 
    // but you can leave that out if you prefer.
    const rawCP =
      (attack * Math.sqrt(defense) * Math.sqrt(stamina) * Math.pow(cpMultiplier, 2)) / 10;
    return Math.floor(rawCP);
  }
