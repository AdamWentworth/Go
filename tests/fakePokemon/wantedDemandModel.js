const TOP_DEMAND = [
  ...
  ['0025-halloween_hat_shiny', 25, 'Shiny Mimikyu Costume Pikachu', 335, { costume: 54 }],
  ...
  ['0384-shiny_mega', 384, 'Shiny Mega Rayquaza', 265, { background: 240, mega: true }],
  ['0383-shiny_primal', 383, 'Shiny Primal Groudon', 260, { background: 240 }],
  ['0382-shiny_primal', 382, 'Shiny Primal Kyogre', 255, { background: 240 }],
  ['0800-shiny_fusion_2', 800, 'Shiny Dawn Wings Necrozma', 250, { background: 240, fusion: 2 }],
  ['0800-shiny_fusion_1', 800, 'Shiny Dusk Mane Necrozma', 246, { background: 240, fusion: 1 }],
  ['0646-shiny_fusion_4', 646, 'Shiny Black Kyurem', 242, { background: 240, fusion: 4 }],
  ['0646-shiny_fusion_3', 646, 'Shiny White Kyurem', 238, { background: 240, fusion: 3 }],
  ['0150-shiny_mega_y', 150, 'Shiny Mega Mewtwo Y', 234, { background: 237, mega: true, megaForm: 'Y' }],
  ['0150-shiny_mega_x', 150, 'Shiny Mega Mewtwo X', 230, { background: 237, mega: true, megaForm: 'X' }],
  ...
  ['0384-mega', 384, 'Mega Rayquaza', 157, { background: 240, mega: true }],
  ['0383-primal', 383, 'Primal Groudon', 154, { background: 240 }],
  ['0382-primal', 382, 'Primal Kyogre', 151, { background: 240 }],
