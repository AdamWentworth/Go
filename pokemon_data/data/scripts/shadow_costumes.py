...
# Specify a single Pokémon image path
pokemon_image_path = "D:\\Visual-Studio-Code\\Go\\frontend\\public\\images\\costumes\\pokemon_403_hat_default.png"
output_directory = "D:\\Visual-Studio-Code\\Go\\frontend\\public\\images\\shadow_costumes"
...
output_file_name = os.path.basename(pokemon_image_path).replace('pokemon_', 'shadow_pokemon_')
...
print(f"Processed the Pokémon image!")
