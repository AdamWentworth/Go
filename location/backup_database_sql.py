...
def backup_database(database_name, output_file, host="localhost", port=5432, username="postgres"):
    try:
        ...
        command = [
            ...
            "--format=plain",  # Generate a plain text SQL file
            "--no-owner",       # Exclude owner information for portability
...
if __name__ == "__main__":
    ...
    # Set output file path for plain SQL format
    output_file = os.path.join(backup_folder, f"locations_backup_{timestamp}.sql")
