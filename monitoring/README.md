...
This folder runs Prometheus + Alertmanager for the Pokemon, authentication, receiver, storage, events, users, and search services.
...
- App-level metrics: request rate, latency, status codes (`pokemon_data`, `auth_service`, `receiver_service`, `storage_service`, `events_service`, `users_service`, `search_service`)
