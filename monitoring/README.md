...
This folder runs Prometheus + Alertmanager for the Pokemon, authentication, receiver, and storage services.
...
- App-level metrics: request rate, latency, status codes (`pokemon_data`, `auth_service`, `receiver_service`, `storage_service`)
