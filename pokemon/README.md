...
The future PostgreSQL catalog is a dedicated `pokemon_catalog_db` service in
this directory's `docker-compose.yml`, not the location/PostGIS database. Its
operational flow lives in
