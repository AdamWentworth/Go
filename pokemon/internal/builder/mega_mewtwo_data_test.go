...
func TestMegaMewtwoDataRows(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			image:     "/images/mega/mega_150_X.png?v=f8169f5",
			shiny:     "/images/shiny_mega/shiny_mega_150_X.png?v=f8169f5",
			cp40:      6112,
			cp50:      6910,
		...
		},
		{
			...
			type1:     "Psychic",
			type2:     sql.NullString{},
			image:     "/images/mega/mega_150_Y.png?v=f8169f5",
			shiny:     "/images/shiny_mega/shiny_mega_150_Y.png?v=f8169f5",
			cp40:      6428,
			cp50:      7267,
			available: "2026-05-25",
		},
